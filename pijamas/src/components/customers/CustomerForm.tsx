...
const SIZES: ProductSize[] = ['PP', 'P', 'M', 'G', 'GG', '2XG', '3XG', '2', '4', '6', '8', '10', '12', '14']
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <Input
        ...
        placeholder="Ex: Conjunto, Camisola, Short Doll"
        value={values.preferred_style}
        onChange={(e) => setValues((v) => ({ ...v, preferred_style: e.target.value }))}
      />

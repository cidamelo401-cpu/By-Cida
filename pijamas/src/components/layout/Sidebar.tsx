  ...
  return (
    <aside className="hidden lg:flex lg:flex-col lg:w-64 lg:shrink-0 lg:h-screen lg:sticky lg:top-0 border-r border-gray-100 bg-white">
      <div className="flex items-center gap-2.5 px-6 py-6">
        <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-primary-100 text-primary-900 text-lg">
          🌙
        </div>
        <div>
          <p className="text-sm font-bold leading-tight text-gray-900">Pijamas <span className="text-accent-400">Digital</span></p>
          ...
          return (
            <Link
              ...
              className={`flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium transition-colors ${
                active ? 'bg-primary-900 text-white' : 'text-gray-600 hover:bg-primary-50 hover:text-primary-900'
              }`}
            >
              {item.icon}
              {item.label}
      ...
      <div className="border-t border-gray-100 px-4 py-3">
        <a
          href={`https://www.instagram.com/${process.env.NEXT_PUBLIC_INSTAGRAM_HANDLE ?? 'pijamasdigital'}`}
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-2 rounded-lg px-2 py-2 text-sm text-gray-400 hover:bg-primary-50 hover:text-primary-900 transition-colors"
        >
          ...
          @{process.env.NEXT_PUBLIC_INSTAGRAM_HANDLE ?? 'pijamasdigital'}
        </a>
      </div>

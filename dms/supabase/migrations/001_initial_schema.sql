-- ============================================================================
-- DMS Camisas - Migração inicial do banco de dados
-- Sistema de gestão de estoque e vendas de camisas de futebol
-- ============================================================================
...
create table if not exists public.products (
  ...
  model text not null check (model in ('titular', 'reserva', 'terceiro', 'goleiro', 'treino')),
  version text not null check (version in ('torcedor', 'jogador')),
...
comment on table public.products is 'Produtos (camisas de futebol) em estoque';

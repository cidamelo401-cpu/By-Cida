          ...
          {photos.map((url, index) => (
            ...
            >
              ...
              <button
                ...
                className="absolute top-1 right-1 h-6 w-6 flex items-center justify-center rounded-full bg-red-600 text-white opacity-90 sm:opacity-0 sm:group-hover:opacity-100 transition-opacity hover:bg-red-700 hover:opacity-100"
              >

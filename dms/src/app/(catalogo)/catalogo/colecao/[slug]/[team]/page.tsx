...
type GroupedShirt = {
  ...
  sizes: { size: Product['size']; quantity: number; id: string; soldOut: boolean }[]
  fallbackId: string
  isKids: boolean
}
                ...
                >
                  <div className="bg-[#1A1A1A] rounded-2xl overflow-hidden border border-white/5 hover:border-[#C9A84C]/40 transition-colors h-full flex flex-col">
                    ...
                    <div className="p-3 flex flex-col gap-1.5 flex-1">
                      ...
                      {/* Faixa completa de tamanhos, riscando o que não tem estoque */}
                      ...
                      {isSobEncomenda ? (
                        <button
                          ...
                          className="mt-1 w-full flex items-center justify-center gap-1 rounded-lg text-[10px] font-bold uppercase py-2 px-1 tracking-tight whitespace-nowrap bg-[#25D366] text-white hover:bg-[#1fb855] transition-colors cursor-pointer border-0"
                        >
